    ...
    public partial class Form3 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (textBox1.Text == "")
            {
                ...
                bx_5k.AreaX = Convert.ToInt16(textBox2.Text);
                bx_5k.AreaX /= 8;
                bx_5k.AreaY = Convert.ToInt16(textBox3.Text);
                bx_5k.AreaWidth = Convert.ToInt16(textBox4.Text);
                bx_5k.AreaWidth /= 8;
                bx_5k.AreaHeight = Convert.ToInt16(textBox5.Text);
