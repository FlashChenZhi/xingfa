...
namespace Led5KSDKDemoCSharp
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            type = t;
            uint hand = ONNONLed5KSDKD.Led5kSDK.CreateBroadCast(broad_ip, broad_port, (Led5kSDK.bx_5k_card_type)card_type_list[t],0);
            m_dwCurHand = hand;
            if (hand == 0)
            {
        ...
        public void UpdateArea(uint i)
        {
            ...
            else
            {
                ...
                {
                    a.bx_5k.DynamicAreaLoc = (byte)i;
                    int x = ONNONLed5KSDKD.Led5kSDK.SCREEN_SendDynamicArea(m_dwCurHand, a.bx_5k, (ushort)a.bx_5k.DataLen, Area.AreaText);
        ...
        {
            int err = ONNONLed5KSDKD.Led5kSDK.SCREEN_DelDynamicArea(m_dwCurHand, 0);
            if (err == 0)
            {
        ...
        private void button45_Click(object sender, EventArgs e)
        {
            ...
            ONNONLed5KSDKD.Led5kSDK.CallBackCon callBack = new ONNONLed5KSDKD.Led5kSDK.CallBackCon(CallBackMethod); ;
            ONNONLed5KSDKD.Led5kSDK.CallBackLedClose callBackLedClose = new ONNONLed5KSDKD.Led5kSDK.CallBackLedClose(CallBackMethod);
            if (ONNONLed5KSDKD.Led5kSDK.StartGprsServer(port, callBack, callBackLedClose)) 
            {
        ...
        private void button52_Click(object sender, EventArgs e)
        {
            ...
            List<byte> tobyte = ds.ToBytes(_Bitmap, Display.ColorType.THREE, Display.MatrixType.RG);
            //foreach (var v in tobyte)
            //{
            //    string b = v.ToString();
            //    string h = Convert.ToString(v, 16);
