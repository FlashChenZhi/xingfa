...
#include <setupapi.h>
#include <devguid.h>
#include "..\\Led5kSDK\\Led5kSDK.h"


#ifdef _DEBUG
#pragma comment(lib,"..\\Debug\\Led5kSdk.lib")
#else
#pragma comment(lib,"..\\Release\\Led5kSdk.lib")
#endif
...
void CLed5kSDKDemoDlg::OnBnClickedButton7()
{
	...
	DWORD hand=CreateBroadCast(ip,port,(bx_5k_card_type)gloabl_type[sel],1);
	if (hand==0)
	{
