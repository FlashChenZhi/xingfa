...
let InputPerformanceQuery = React.createClass({
    getInitialState() {
        return {
            data: [],
            total: 0,//表格数据总行数
    ...
    getTableData(currentPage){
        ...
        reqwest({
            url: '/wms/query/inputPerformance.do',
            dataType: 'json',
            method: 'post',
            data: values,
...
InputPerformanceQuery = Form.create({})(InputPerformanceQuery);
export default InputPerformanceQuery;
