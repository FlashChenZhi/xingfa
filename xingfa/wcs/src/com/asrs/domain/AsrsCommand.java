...
public class AsrsCommand
{
      ...
      @SequenceGenerator(name = "seq", sequenceName = "SEQ_ASRSCOMMAND_ID", allocationSize = 1)
      ...
      public boolean equals(Object o)
      {
            ...
            AsrsCommand that = (AsrsCommand) o;
      ...
      public static List<AsrsCommand> getAsrsCommands()
      {
            Session session = HibernateUtil.getCurrentSession();
            return session.createCriteria(AsrsCommand.class).list();
      }
}
