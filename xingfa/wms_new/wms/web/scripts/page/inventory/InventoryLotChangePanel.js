var InventoryLotChangePanel = function (data) {
    ...
    this.invQcPanel = Ext.create("Ext.form.Panel", {
        ...
        items: [
            ...
            },
            {
                ...
                items: [
                    this.cmp.com_reservedType,
                    this.cmp.com_frozenType,
    ...
    this.store = Ext.create("Ext.data.JsonStore", {
        ...
        proxy: {
            type: "ajax",
            url: "wms/inventoryLotChange/search",
                ...
                Ext.Msg.show({
                    ...
                    fn: function (btn) {
                        if (btn === 'yes') {
                            ...
                            for (var res in sels) {
                                results.push({inventoryId : sels[res].data.inventoryId});
                            }
                            ...
                            mask.show();
                            Ext.Ajax.request({
                                url: 'wms/inventoryLotChange/exceptionCancel',
    ...
    this.batchChangeBtn = Ext.create("Ext.button.Button", {
        text: "批量变更质检标志",
        scope: this,
        handler: function () {
            var sels = this.grid.getSelection();
            ...
            var batWin = new BatchInventoryChangeWin(data);
            batWin.init(this.store,sels,true);
            batWin.win.show();
                        ...
                        items: [
                            {
                                ...
                                scope: this,
                                handler: function () {
                                    win = new InventoryLotChangeWin(data);
                                ...
                                scope: this,
                                handler: function () {
                                    win = new InventoryChangeWin(data);
                                    var rowData = record.data;
                                    win.init(rowData, this.store,true);
                                    win.win.show();
                                }
                            }
                        ]
            ...
            dockedItems: [
                {
                    ...
                    dock: "top",
                    scope: this,
                    items: [this.finishBtn,this.batchChangeBtn]
                },
                {
                    xtype: "pagingtoolbar",
                    store: this.store,
