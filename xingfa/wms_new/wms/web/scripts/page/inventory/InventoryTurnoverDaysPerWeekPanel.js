var InventoryTurnoverDaysPerWeekPanel = function (data) {
    ...
    this.store = Ext.create("Ext.data.JsonStore", {
        ...
        proxy: {
            type: "ajax",
            url: "wms/inventoryTurnOver/searchWeek",
            timeout: 960000,
