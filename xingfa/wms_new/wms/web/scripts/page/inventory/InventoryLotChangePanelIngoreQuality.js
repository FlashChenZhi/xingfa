var InventoryLotChangePanelIngoreQuality = function (data) {
    ...
    this.batchChangeBtn = Ext.create("Ext.button.Button", {
        ...
        handler: function () {
            ...
            batWin.init(this.store, sels,false);
            batWin.win.show();
                        ...
                        items: [
                            {
                                ...
                                handler: function () {
                                    ...
                                    win.init(rowData, this.store,false);
                                    win.win.show();
                                }
                            }
                        ]
