  ...
  public static int ML01ArrayOut(RetrievalOrderLine rol,String orderposition,int dingdanshuliang ,int outType) throws Exception{
      ...
      if(outType==1){
          ...
          Query query2 = HibernateUtil.getCurrentSession().createQuery("from Inventory i where " +
                  ...
                  " i.container.location.position =:position and i.container.location.abnormal = false and not exists (select 1 from Location l where " +
                  ...
                  " l.seq2 < i.container.location.seq2 and l.seq > i.container.location.seq and l.reserved = true ) " +
