...
public class StoreResult {
    ...
    @SequenceGenerator(name = "seq", sequenceName = "SEQ_STORE_RESULT_ID", allocationSize = 1)
    @Column(name = "ID")
    public int getId() {
        return id;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (storeDate != null ? !storeDate.equals(that.storeDate) : that.storeDate != null) return false;
        if (storeTime != null ? !storeTime.equals(that.storeTime) : that.storeTime != null) return false;
