...
{
    public partial class PalletStockIn1FEtForm : Form
    {
        ...
        private void txtBucketNo_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == Convert.ToChar(Keys.Enter))
            {
                try
                {
                    ...
                    palletInfoRft = ServiceFactoryEt.getCurrentService().getPalletInfoByBucketNoForPalletStockIn1F(bucketNo);
        ...
        private void txtLocationNo_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == Convert.ToChar(Keys.Enter))
            {
                try
                {
                    ...
                    locationRFT locationRft = ServiceFactoryEt.getCurrentService().getLocationInfoByLocationNoForPalletStockIn1F(locationNo);
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ServiceFactoryEt.getCurrentService().doPalletStockIn1F(bucketNo, locationNo);
