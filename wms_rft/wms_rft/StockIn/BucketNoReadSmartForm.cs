...
{
    public partial class BucketNoReadSmartForm : Form
    {
        ...
        private void BucketInquiryForm_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                bcrNos = ServiceFactorySmart.getCurrentService().getErrorBcrNo();
                currentBcrPageNo = 1;
                showBcrNo();
            }
            catch (Exception ex)
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ServiceFactorySmart.getCurrentService().doBcrNoRead(bcrNo, bucketNo);
