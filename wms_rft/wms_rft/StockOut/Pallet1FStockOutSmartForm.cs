...
{
    public partial class Pallet1FStockOutSmartForm : Form
    {
        ...
        public Pallet1FStockOutSmartForm(string jobId, string jobCollectionNo)
        {
            InitializeComponent();
            this.jobId = jobId;
        ...
        private void Pallet1FStockOutForm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                palletJobInfoRft = ServiceFactorySmart.getCurrentService().getPalletJobInfoById(jobId);
...
//            lblPlanQty.Text = palletJobInfoRft.planQty.ToString("0");
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                stockOutResultRFT stockOutResultRft = ServiceFactorySmart.getCurrentService().donePalletJob(jobId, bucketNo);
...
//                    string palletId = string.IsNullOrEmpty(palletJobInfoRft.palletId) ? string.Empty : palletJobInfoRft.palletId;
                    string palletId = bucketInfoRft != null
                                            ...
                                            : string.Empty;
                    emptyInfoRFT emptyInfoRft = ServiceFactorySmart.getCurrentService().getEmptyInfo(locationNo, palletId, string.Empty, string.Empty);
        ...
        private void btnPass_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                palletJobInfoRft = ServiceFactorySmart.getCurrentService().getNextPalletJobInfoByCollectionJobNo(jobCollectionNo, priority.ToArray(), pass.ToArray());
