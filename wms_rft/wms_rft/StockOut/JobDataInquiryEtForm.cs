...
{
    public partial class JobDataInquiryEtForm : Form
    {
        ...
        {           
            ...
            try
            {
                ...
                {
                    Form form = new Pallet1FStockOutEtForm(jobInfoRft.jobId, jobInfoRft.jobCollectionNo);
                ...
                else if (!jobInfoRft.exception)
                {
                    ...
                    Form form = new ItemStockOutEtForm(jobKeyRft, jobInfoRft.jobCollectionNo);
        ...
        private void txtBarcode_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == Convert.ToChar(Keys.Enter))
            {
                try
                {
                    ...
                    jobInfoRfts = ServiceFactoryEt.getCurrentService().getJobInfoListByBarcode2(barcode);
