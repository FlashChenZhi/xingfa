...
{
    public partial class ItemStockOutEtForm : Form
    {
        ...
        public ItemStockOutEtForm(jobKeyRFT jobKeyRft, string jobCollectionNo)
        {
            InitializeComponent();
        ...
        private void ItemStockOutForm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                jobDetailInfoRft = ServiceFactoryEt.getCurrentService().getJobInfoByKey(jobKeyRft);
                if (jobDetailInfoRft == null)
                {
                    jobDetailInfoRft = ServiceFactoryEt.getCurrentService().getNextJobInfoByCollectionJobNo2(jobCollectionNo, jobKeyRft);
                }
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    bucketInfoRft = ServiceFactoryEt.getCurrentService().getBucketInfoByBucketNoForBucketInquiry(temp);
                    stockOutResultRft = ServiceFactoryEt.getCurrentService().doneJob2(jobKeyRft, temp, destBucketNo, destBagNo);
                }
                else
                {
                    stockRft = ServiceFactoryEt.getCurrentService().getStockInfoByBagNoForBagInquiry(temp);
                    stockOutResultRft = ServiceFactoryEt.getCurrentService().doneBagJob2(jobKeyRft, temp, destBucketNo, destBagNo);
                }
                ...
                if (jobDetailInfoRft != null)
                {
                    ...
                    emptyInfoRFT emptyInfoRft = ServiceFactoryEt.getCurrentService().getEmptyInfo(locationNo, palletId, bucketNo, bagNo);
        ...
        private void btnCancel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ServiceFactoryEt.getCurrentService().jobCancel(jobKeyRft);
                clearAll();
