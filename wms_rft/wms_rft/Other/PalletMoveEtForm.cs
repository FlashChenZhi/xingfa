...
{
    public partial class PalletMoveEtForm : Form
    {
        ...
        private void txtBucketNo_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == Convert.ToChar(Keys.Enter))
            {
                try
                {
                    ...
                    palletInfoRft = ServiceFactoryEt.getCurrentService().getPalletInfoByBucketNoForPalletMove(bucketNo);
        ...
        private void txtLocationNo_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == Convert.ToChar(Keys.Enter))
            {
                try
                {
                    ...
                    locationRFT locationRft = ServiceFactoryEt.getCurrentService().getLocationInfoByLocationNoForPalletMove(locationNo);
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ServiceFactoryEt.getCurrentService().doPalletMove(bucketNo, locationNo);
                ...
                emptyInfoRFT emptyInfoRft = ServiceFactoryEt.getCurrentService().getEmptyInfo(bucketInfoRft.locationNo.PadRight(13, '0'), string.Empty, string.Empty, string.Empty);
