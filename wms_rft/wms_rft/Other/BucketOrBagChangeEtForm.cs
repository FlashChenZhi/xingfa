...
{
    public partial class BucketOrBagChangeEtForm : Form
    {
        ...
        public BucketOrBagChangeEtForm()
        {
            InitializeComponent();
        }
        ...
        private void txtOriginalBucketNoOrBagNo_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == Convert.ToChar(Keys.Enter))
            {
                try
                {
                    ...
                    {
                        stockRFT stockRft = ServiceFactoryEt.getCurrentService().getStockInfoByBagNoForBagInquiry(temp);
                        if (stockRft != null)
                        {
                    ...
                    {
                        bucketInfoRFT bucketInfoRft = ServiceFactoryEt.getCurrentService().getBucketInfoByBucketNoForBucketInquiry(temp);
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ServiceFactoryEt.getCurrentService().changeBagNo(originalTemp, newTemp);
                }
                ...
                {
                    ServiceFactoryEt.getCurrentService().changeBucketNo(originalTemp, newTemp);
                }
                else
                {
