...
{
    public partial class BagMoveForm : Form
    {
        ...
        private void txtBucketNo_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == Convert.ToChar(Keys.Enter))
            {
                try
                {
                    ...
                    bucketInfoRFT bucketInfoRft = ServiceFactorySmart.getCurrentService().getBucketInfoByBucketNoForBagMove(bucketNo);
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ServiceFactorySmart.getCurrentService().doBagMove(bagNo, bucketNo);
//                emptyInfoRFT emptyInfoRft = ServiceFactorySmart.getCurrentService().doBagMove(bagNo, bucketNo);
...
//                }
                ...
                emptyInfoRFT emptyInfoRft = ServiceFactorySmart.getCurrentService().getEmptyInfo(bagStockRft.locationNo.PadRight(13, '0'), bagStockRft.palletId, bagStockRft.bucketNo, string.Empty);
        ...
        private void BagMoveForm_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
