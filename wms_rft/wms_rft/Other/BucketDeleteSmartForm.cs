...
{
    public partial class BucketDeleteSmartForm : Form
    {
        ...
        private void txtBucketNo_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == Convert.ToChar(Keys.Enter))
            {
                try
                {
                    ...
                    bucketInfoRft = ServiceFactorySmart.getCurrentService().getBucketInfoByBucketNoForBucketInquiry(bucketNo);
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ServiceFactorySmart.getCurrentService().doBucketDelete(bucketNo, userId);
...
//                }
                ...
                emptyInfoRFT emptyInfoRft = ServiceFactorySmart.getCurrentService().getEmptyInfo(biRft.locationNo.PadRight(13, '0'), biRft.palletId, bucketNo, string.Empty);
