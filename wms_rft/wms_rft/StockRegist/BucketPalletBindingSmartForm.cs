...
{
    public partial class BucketPalletBindingSmartForm : Form
    {
        ...
        public BucketPalletBindingSmartForm()
        {
            InitializeComponent();
        }
        ...
        private void doBucketNo(string bucketNo)
        {
            ...
            stockRFT stock = ServiceFactorySmart.getCurrentService().getOneStockByBucketNo(bucketNo);
        ...
        private void doToPalletNo(string palletNo)
        {
            ...
            palletInfoRFT pallet = ServiceFactorySmart.getCurrentService().peekPalletInfoByPalletNo(palletNo);
        ...
        {
            palletInfoRFT pallet = ServiceFactorySmart.getCurrentService().peekPalletInfoByBucketNo(bucketNo);
            lblMixedLoad.Text = pallet.mixedLoad.ToString("0");
            lblNumOfBucket_L.Text = pallet.numOfBucket.ToString("0");
        }
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ServiceFactorySmart.getCurrentService().bindPalletAndBucketsByBucketNo(bucketNos, temp);
                }
                else
                {
                    ...
                    ServiceFactorySmart.getCurrentService().bindPalletAndBucketsByPalletNo(bucketNos, temp);
                }
