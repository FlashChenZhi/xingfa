...
{
    public partial class PreM2Form : Form
    {
        ...
        private void PreM2Form_Load(object sender, EventArgs e)
        {
        ...
        private void clearAll()
        {
            ...
            txtPlanWeight.Text = string.Empty;
        ...
        private void PreM2Form_Closing(object sender, System.ComponentModel.CancelEventArgs e)
        {
            try {
...
//                    }
        ...
        private bool doTicketNo(string ticketNo)
        {
            ...
            txtPlanWeight.Text = stock.planWeight.ToString("0.####");
...
//                }
        ...
        private void PreM2Form_KeyDown(object sender, KeyEventArgs e)
        {
            try {
                if (e.KeyCode == Keys.Down) {
                    if (txtBucketNo.Focused) {
                        ...
                        btnNoPr.Focus();
                    } else if (btnNoPr.Focused) {
                        txtPlanWeight.SelectAll();
                        txtPlanWeight.Focus();
                    } else if (txtPlanWeight.Focused) {
                        btnSubmit.Focus();
                ...
                } else if (e.KeyValue == 94)//R Button
                {
                    ...
                    if (txtPrTicket.Focused) {
                        ...
                        btnNoPr_Click(btnNoPr, eventArgs);
                    }
                }
            } catch (Exception ex) {
                msgHelper.showError(ex.Message);
        ...
        private void btnNoPr_Click(object sender, EventArgs e)
        {
            lblItemCode.Text = "PRE_M2";
            lblItemName1.Text = string.Empty;
            lblItemName2.Text = string.Empty;
            lblItemName3.Text = string.Empty;
            lblColorCode.Text = string.Empty;
            ...
            lblLine1.Text = string.Empty;
            lblLine2.Text = string.Empty;
            lblPrNo.Text = "9999999999";

            txtPrTicket.Text = "9999999999";

            txtPlanWeight.Text = "20";
